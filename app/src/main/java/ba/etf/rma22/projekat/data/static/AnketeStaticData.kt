...
fun sveAnkete():List<Anketa>{
    ...
    return listOf(
        ...
        Anketa("Anketa 1","Istrazivanje 1",postaviDatum(2023,1,1),postaviDatum(2023,2,1),postaviDatum(2023,1,11),55,"I1-G1",0.30f),
        ...
        Anketa("Anketa 5","Istrazivanje 3",postaviDatum(2022,2,20),postaviDatum(2023,4,21),postaviDatum(2022,4,11),7,"I3-G1",0.79f),
        Anketa("Anketa 6","Istrazivanje 3",postaviDatum(2022,4,10),postaviDatum(2023,4,15),postaviDatum(2021,5,12),34,"I3-G2",null),

        Anketa("Anketa 7","Istrazivanje 4", postaviDatum(2022,1,18),postaviDatum(2022,7,13),Calendar.getInstance().time,34,"I4-G1",0.29F),
        ...
        Anketa("Anketa 10","Istrazivanje 5",postaviDatum(2021,12,10),postaviDatum(2022,10,15),postaviDatum(2022,1,11),37,"I5-G1",0.42f),
        ...
        Anketa("Anketa 13","Istrazivanje 6",postaviDatum(2022,1,1),postaviDatum(2023,10,14),null,73,"I6-G2",null),
        ...
        Anketa("Anketa 24","Istrazivanje 11",postaviDatum(2022,1,1),postaviDatum(2022,7,13),postaviDatum(2021,1,12),54,"I11-G2",0.45f),

        Anketa("Anketa 25","Istrazivanje 11",postaviDatum(2022,4,30),postaviDatum(2022,9,27),null,61,"I12-G1",null),
